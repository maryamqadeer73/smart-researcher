...
- `[x]` Backend: Implement save settings endpoint and server-side image proxy for Gemini 2.5 Flash Image (Nano Banana)
- `[x]` Frontend: Add Gemini API Key input field and load/save handlers
- `[x]` Frontend: Route image calls to the local proxy endpoint
- `[x]` Verification: Verify E2E Gemini generation and fallback
